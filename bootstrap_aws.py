...
def configure_apigateway(stage):
    '''
        ...
        #todo - allow me to explictly state which aws credential profile to use
        --- this isn't working right now at all and seems kind of tricky to get working.
        --- probably only a few lines of code to do it but driving me crazy so avoiding
        --- and just going to do proxy through a lambda function like the lazy person I am.
    '''
